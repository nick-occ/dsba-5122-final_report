...
As part of the data characterization, we felt it was important to identify which opioids were the used the most based on different variables. To provide this information to the user we developed a word cloud encoding showing the most highly recorded opioids. The most recorded opioids are displayed larger than the remaining values which scale down in order of frequency, so it is clear to the user which opioids are used the most.
